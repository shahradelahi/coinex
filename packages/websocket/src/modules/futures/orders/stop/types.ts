...
/**
 * @interface FuturesStopOrderSubscriptionParams
 * @description Parameters for subscribing to user stop order updates.
 */
export interface FuturesStopOrderSubscriptionParams {
  /**
...
/**
 * @interface FuturesStopOrderUnsubscribeParams
 * @description Parameters for unsubscribing from user stop order updates.
 */
export interface FuturesStopOrderUnsubscribeParams {
  /**
...
/**
 * @interface FuturesStopOrder
 * @description Represents a single stop order.
 */
export interface FuturesStopOrder {
  /**
  ...
  /**
   * @property {TriggerPriceType} trigger_price_type - Trigger price type.
   */
